...
const ACTION_ROLES = new Map([
  ...
  ["zk-owner-key-register", new Set(["distributor"])],
  ["zk-owner-key-revoke", new Set(["distributor"])],
  ...
  ["zk-transfer-finality-cancel", new Set(["operations"])],
  ["zk-parameters-propose", new Set(["operations"])],
  ["zk-parameters-approve", new Set(["operations"])],
...
const ACTION_PERMISSIONS = new Map([
  ...
  ["zk-owner-key-register", "confidential.owner_key.register"],
  ["zk-owner-key-revoke", "confidential.owner_key.revoke"],
  ...
  ["zk-transfer-finality-cancel", "transaction.zk.finalize.cancel"],
  ["zk-parameters-propose", "zk.parameters.propose"],
  ["zk-parameters-approve", "zk.parameters.approve"],
